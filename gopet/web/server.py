...
def _parse_select_move_payload(payload: object) -> tuple[int, list[str], bool]:
    ...
    return board_size_raw, moves_raw, against_human_raw
...
def create_app(agents: Optional[Dict[str, Agent]] = None, model_path: Optional[str] = None) -> Flask:
    ...
    def select_move(agent_name: str):
        ...
        try:
            board_size, moves, against_human = _parse_select_move_payload(payload)
